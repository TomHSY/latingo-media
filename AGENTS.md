...
| `npm run publish:carousel-if-scheduled` | Tue 18:00 Paris → carousel only (GitHub Actions) |
| `npm run publish:stories-if-scheduled` | Mon–Fri 17:00 / Sat–Sun 12:00 Paris → stories (Cloudflare Worker cron) |
